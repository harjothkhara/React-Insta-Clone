  ...
  return (
    <div className="post">
      <div className="post-header">
        <img className="thumbnail" src={this.props.data.thumbnailUrl} alt="profile thumbnail"/>
        <h2>{this.props.data.username}</h2>
      </div>
      <img className="post-img" src={this.props.data.imageUrl} alt="post" />   
     <div className="post-footer">
        ...
        <CommentSection comments={this.props.data.comments} timestamp={this.props.data.timestamp} />
      </div>
  </div>    
  )
}
